    ...
    <section className={styles.projects}>
      ...
      <div className={styles.items}>
        ...
        <div className={styles.work}>
          ...
          <h4><a href='https://www.fringecosmetology.com/' target="_blank">Fringe Cosmetology Consulting</a></h4>
        ...
        <div className={styles.work}>
          ...
          <div className={styles.text}>
          <h4><a href='https://www.devilsdetailsgb.com/' target="_blank">Devil's Details</a></h4> 
        ...
        <div className={styles.work}>
          ...
          <div className={styles.text}>
          <h4><a href="https://basicjscounter.netlify.app/" target="_blank">Click Counter</a></h4> 
        ...
        <div className={styles.work}>
          ...
          <div className={styles.text}>
          <h4> <a href="https://zandersbirthday.netlify.app/" target="_blank">Evite site</a></h4> 
